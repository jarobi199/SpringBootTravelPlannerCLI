...
public class SelectTripBudgetStep implements IWizardStep {
    ...
    public WizardResult execute(WizardContext context) {
        ...
        List<Trip> trips = tripService.findByUserIdAndStatusIn(SessionContext.getCurrentUser().getId(), List.of(TripStatus.PLANNED, TripStatus.ACTIVE, TripStatus.COMPLETED));
