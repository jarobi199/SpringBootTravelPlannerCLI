...
public class SelectTripJournalStep implements IWizardStep {
    ...
    public WizardResult execute(WizardContext context) {
        ...
        List<Trip> trips = tripService.findByUserIdAndStatusIn(SessionContext.getCurrentUser().getId(), List.of(TripStatus.COMPLETED, TripStatus.ACTIVE));
